...
def brand_retrieval(parsed_url):
    ...
    brand_name = parsed_url.find_all(class_='link_gray_listing')[2].text.split()[0]
    return brand_name
...
def power_retrieval(parsed_listing_url):
    try:
        power = parsed_listing_url.find_all(class_='row_info')[10].text.split()[2][1:]
    except:
        power = parsed_listing_url.find_all(class_='row_info')[12].text.split()[2][1:]
    return power
...
def manufactured_year_retrieval(parsed_listing_url):
    manufactured_year = parsed_listing_url.find_all(class_='row_info')[6].text.split()[0]
    if len(manufactured_year) != 4:
        manufactured_year = parsed_listing_url.find_all(class_='row_info')[7].text.split()[0]
    return manufactured_year

# Transmission Retriever
def transmission_retrieval(parsed_listing_url):
    transmission = parsed_listing_url.find_all(class_='row_info')[7].text.split()[0]
    if transmission not in ["Auto","Manual"]:
        transmission = parsed_listing_url.find_all(class_='row_info')[8].text.split()[0]
    return transmission
...
def type_of_vehicle_retrieval(parsed_listing_url):
    type_of_vehicle = parsed_listing_url.find_all(class_='row_info')[6].text.split()[0]
    if len(type_of_vehicle) == 4:
